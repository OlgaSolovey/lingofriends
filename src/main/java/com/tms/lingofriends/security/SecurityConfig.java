...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http.csrf().disable()
                ...
                .requestMatchers(HttpMethod.GET, "/user/getCourse/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.POST, "/user/**").permitAll()
                .requestMatchers(HttpMethod.POST, "/user/addcourse").hasAnyRole("ADMIN", "USER")
                ...
                .requestMatchers(HttpMethod.POST, "/course/**").hasAnyRole("ADMIN", "USER")
                .requestMatchers(HttpMethod.PUT, "/course/**").hasAnyRole("ADMIN", "USER")
                ...
                .requestMatchers(HttpMethod.POST, "/lesson/**").hasAnyRole("ADMIN", "USER")
                .requestMatchers(HttpMethod.PUT, "/lesson/**").hasAnyRole("ADMIN", "USER")
